...
<p>
	<img src="./assets/pg_hba_path.png" alt="pic" onclick="{window.open(this.src, '_blank')}" style="cursor: pointer;">
</p>
...
<p>
	<img src="./assets/pg_hba_windows.png" alt="pic" onclick="{window.open(this.src, '_blank')}" style="cursor: pointer;">
</p>
...
<p>
	<img src="./assets/pg_hba_trust.png" alt="pic" onclick="{window.open(this.src, '_blank')}" style="cursor: pointer;">
</p>
